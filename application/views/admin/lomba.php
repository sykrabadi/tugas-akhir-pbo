                ...
                <div class="container-fluid">
                  ...
                  <div class="row">
                    <div class="col-lg">
                      ...
                      <a href="" class="btn btn-success mb-3" data-toggle="modal" data-target="#newSubMenuModal"><i class="fas fa-plus"></i> Tambah Lomba</a>
                        ...
                        <tbody>
                          ...
                          <?php foreach ($lomba as $l) : ?>
                            <tr>
                              ...
                              <td><?= $l['tingkat']; ?></td>
                              <td>
                                <a href="<?= base_url('user/daftarPeserta/'); ?><?= $l['id']; ?>" class="badge badge-info">Daftar Peserta</a>
